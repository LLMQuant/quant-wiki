...
paper_index = {
    "traditional quantitative finance": "传统量化金融",
    "financial time-series forecasting": "金融时间序列",
    "financial large language model": "金融大语言模型",
}
...
def get_daily_papers(topic, query="quantitative finance", max_results=2):
    ...
    cn_topic_key = paper_index[topic]
    query_folder_path = os.path.join("docs/advanced/学术论文", cn_topic_key, today_date)
    ...
    for result in search_engine.results():
        ...
        try:
            ...
            if repo_url is not None:
                ...
                content_to_web[paper_key] = "- {}, **{}**, {} et.al., Paper: [{}]({}), Abstract: {}\n".format(
...
def json_to_md(
    filename, md_filename, task="", to_web=False, use_title=True, use_tc=True, show_badge=True, use_b2t=True
):
    """
    @param filename: str
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_path", type=str, default="./docs/advanced/学术论文/config.yaml", help="configuration file path"
    )
    parser.add_argument(
